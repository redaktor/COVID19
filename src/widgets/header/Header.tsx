			...
			<nav role="navigation" classes={[themedCss.menu]} aria-label="Main Menu">
				<ul classes={themedCss.menuList}>
					<li classes={[themedCss.menuItem]}>
						<a href="#" classes={[css.link, css.lang, langClass('en')]} onclick={ lang('en') }>
							English
						</a>
					</li>
					<li classes={[themedCss.menuItem]}>
						<a href="#" classes={[css.link, css.lang, langClass('fr')]} onclick={ lang('fr') }>
							Français
						</a>
					</li>
					<li classes={[themedCss.menuItem]}>
						<a href="#" classes={[css.link, css.lang, langClass('de')]} onclick={ lang('de') }>
							Deutsch
						</a>
					</li>
					<li classes={[themedCss.menuItem]}>
